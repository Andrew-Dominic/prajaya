...
<head>
  ...
  <title>Congratulations! Volunteer Selection</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f4f3f8; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; color: #403d58;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #f4f3f8; padding: 40px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 580px; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 35px rgba(44, 41, 70, 0.08); border: 1px solid #ebe9f2;">
          <!-- Header Banner with Brand Colors (#2C2946 & #f2bb47) -->
          <tr>
            <td style="background-color: #2C2946; padding: 36px 32px; text-align: center;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                <tr>
                  <td style="background: rgba(242, 187, 71, 0.15); border: 1px solid rgba(242, 187, 71, 0.4); border-radius: 30px; padding: 5px 16px; display: inline-block;">
                    <span style="color: #f2bb47; font-size: 11px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase;">Official Confirmation</span>
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            <td style="padding: 40px 36px 32px 36px;">
              <h2 style="margin: 0 0 18px 0; color: #2C2946; font-size: 24px; font-weight: 700;">
                Congratulations!
              </h2>
              ...
              <!-- Highlighted Volunteer Code Box matching Website Accent -->
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #fcf9f2; border: 2px dashed #f2bb47; border-radius: 16px; margin: 0 0 28px 0;">
                <tr>
                  <td style="padding: 24px 20px; text-align: center;">
                    <span style="font-size: 11px; font-weight: 700; color: #9c6c0c; text-transform: uppercase; letter-spacing: 1.5px; display: block; margin-bottom: 8px;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #f4f3f8; border-left: 4px solid #f2bb47; border-radius: 0 12px 12px 0; margin: 0 0 28px 0;">
                <tr>
                  <td style="padding: 18px 20px;">
                    <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #403d58;">
              ...
              <p style="margin: 0; font-size: 15px; color: #403d58; line-height: 1.6;">
                Thank you for your dedication to serving the community!<br><br>
                Warm regards,<br>
                <strong style="color: #2C2946;">Prajaya Foundation Team</strong>
              </p>
            </td>
          </tr>
          ...
          <!-- Footer -->
          <tr>
            <td style="background-color: #f4f3f8; border-top: 1px solid #ebe9f2; padding: 22px 32px; text-align: center;">
              <p style="margin: 0; font-size: 12px; color: #7a7696; line-height: 1.6;">
                &copy; ${new Date().getFullYear()} Prajaya Foundation. All Rights Reserved.<br>
                Empowering communities & creating sustainable impact.
              </p>
            </td>
          </tr>
        </table>
